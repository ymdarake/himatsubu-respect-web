    ...
    return (
        <div className="p-3 bg-gray-900 bg-opacity-50 rounded border-2 border-gray-600 h-full flex flex-col justify-between">
            <div className="grid grid-cols-2 sm:grid-cols-1 gap-x-2 gap-y-1">
                <div className="flex justify-between col-span-2 sm:col-span-1"><span>プレイ時間</span><span className="font-bold">{formatPlayTime(playStats.playTime)}</span></div>
                ...
                <div className="flex justify-between col-span-2 sm:col-span-1"><span>所持ゴールド</span><span className="font-bold text-yellow-400">{player.gold} G</span></div>
            </div>
